const MusicPlayerApp = (() => {
    ...
    function playSong(songIndex) {
        ...
        audio.src = `https://songs.goodspeedwang.dpdns.org/${encodeURIComponent(sanitizeFileName(currentAlbum.name))}/${encodeURIComponent(sanitizeFileName(currentSong))}.mp3`;

...
//https://i.smart-chat.net/ysp.php?id=cctv1
...
function generateGuid() {
    ...
    $randomPart = substr(str_shuffle(str_repeat('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789', 10)), 0, 11);
...
$headers = [
        ...
        "Cookie: guid={$guid}; versionName=99.99.99; versionCode=999999; vplatform=109; platformVersion=Chrome; deviceModel=121; updateProtocol=1; seqId=1; request-id={$request_id}",
        "Yspappid: 519748109",
